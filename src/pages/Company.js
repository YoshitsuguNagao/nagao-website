      ...
      <div className="company main-container">
        <section className="introduction wrap">
          ...
          <div className="intro-container">
            <div className="intro-content">
              <p className="intro-text">{data.introduction[1]}</p>
        ...
        <section className="history-section wrap">
          ...
          <div className="history-container">
            {histories.map((history, index) => {
              return this.showHistory(history, index);
            })}
          </div>
        </section>
        <section className="csr-section wrap">
          ...
          <div className="csr-container">
            <p>
              初倉まつり2018に参加。静岡県重機建設業工業組合青年部の一員として地域の子供たちに建設機械と触れ合ってもらいました。
            </p>
            <div className="csr-img-container">
              <img
                className="csr-img p-4"
                src="https://res.cloudinary.com/yoshitsugunagao/image/upload/v1571205516/nagao-website/csr1.jpg"
                alt=""
              />
              <img
                className="csr-img p-4"
                src="https://res.cloudinary.com/yoshitsugunagao/image/upload/v1571205516/nagao-website/csr2.jpg"
                alt=""
              />
            </div>
          </div>
