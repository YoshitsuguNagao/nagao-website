    ...
    return (
      <div className="contact">
        ...
        <div className="contact-info">
          <h3>御前崎本社</h3>
          <h4>〒437-1604 静岡県御前崎市佐倉1041-1</h4>
          <h4>TEL: 0537-86-6410</h4>
          <h4>FAX: 0537-86-3556</h4>
        </div>
        ...
        <div className="contact-info">
          <h3>静岡営業所</h3>
          <h4>〒422-8034 静岡県静岡市駿河区高松１丁目179番地</h4>
          <h4>TEL: 054-236-6410</h4>
          <h4>FAX: 054-236-6411</h4>
        </div>
